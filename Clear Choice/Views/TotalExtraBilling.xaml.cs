...
namespace Clear_Choice.Views
{
    ...
    public partial class TotalExtraBilling : UserControl
    {
        ...
        private void LoadGrid()
        {
            try
            {
                DataSet data = db.Select("ExtraItem,SUM(Quantity) AS Quantity,AVG(UnitPrice) As UnitPrice,SUM(TotalPrice) As TotalPrice", LotExtra.Table, "BilledQuantity > 0 GROUP BY ExtraItem");
                Collection<TotalBilledExtraBinding> gridData = data.getBindableCollection<TotalBilledExtraBinding>();
        ...
        {
            Hashtable textMap = TotalBilledExtraBinding.GetDisplayTextMap();
        ...
        private void button1_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                currenyField.Add("UnitPrice");
                currenyField.Add("TotalPrice");

                FlowDocument doc = itemRecords.GetFlowDocument(title, null, TotalBilledExtraBinding.GetDisplayTextMap(), currenyField);
