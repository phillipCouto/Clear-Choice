    ...
    public partial class TotalMaterialCost : UserControl
    {
        ...
        private void LoadGrid()
        {
            try
            {
                ...
                {
                    data = db.Select("sites.SiteName,Sum(TotalQuantity)AS Quantity, SUM(TotalValue) AS TotalValue", Site.Table + "," + InventoryTransaction.Table, "sites.siteID = inventory_transactions.assocID Group By sites.siteID","sites.SiteName");
                ...
                {
                    data = db.Select("lots.LotNumber,lots.Address,lots.City,Sum(TotalQuantity)AS Quantity, SUM(TotalValue) AS TotalValue", Lot.Table + "," + InventoryTransaction.Table, "lots.lotID = inventory_transactions.assocID Group By lots.lotID", "lots.City,lots.Address,lots.LotNumber");
